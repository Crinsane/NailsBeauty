    ...
    <div class="section-title">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 text-center">
                <h2 class="font-italic"><span><?php echo get_option('section_contact_title', 'Contact US');?></span></h2>
                <div class="subtitle-divider-2 text-center"><?php echo get_option('section_contact_subtitle', '');?></div>
            </div>
        </div>
    </div>
